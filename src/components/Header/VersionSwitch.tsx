...
export default function VersionSwitch() {
  ...
  const toggle = (
    <VersionToggle enabled={versionSwitchAvailable} to={toggleDest} onClick={handleClick}>
      <VersionLabel enabled={version === Version.v2 || !versionSwitchAvailable}>竞猜开发中</VersionLabel>
  ...
  return versionSwitchAvailable ? (
    ...
    <MouseoverTooltip text="This page is only compatible with Lotto Swap">{toggle}</MouseoverTooltip>
  )
}
